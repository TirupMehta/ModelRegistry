...
export const companies: Record<string, Company> = {
  ...
  cohere: {
    ...
    accentColor: "#14b8a6",
    description: "Enterprise RAG and agentic coding specialists behind North Mini Code (30B MoE) and open-weight Command A (111B).",
    latestFlagship: "Command A (111B)",
    latestReasoning: "North Mini Code",
    openWeightsAdvocate: true,
  },
}
