...
export const modelsData: ModelItem[] = [
  ...
  },
  {
    ...
    isCompanyFlagship: false,
    isLatestCheckpoint: true,
    statusBadge: "NEW MULTIMODAL SPARK",
    category: "open-weights",
    ...
    highlight: "Released Sept 3, 2026; Meta's ultra-low latency real-time multimodal foundation model designed for simultaneous voice, vision perception, and generative interaction with sub-80ms first-token response.",
    modalities: ["Text", "Vision", "Audio", "Code"],
    benchmarks: {
      mmluPro: "81.9%",
      gpqa: "68.4%",
